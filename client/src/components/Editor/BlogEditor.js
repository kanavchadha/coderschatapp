...
class ImageBlot extends BlockEmbed {
    ...
    static create(value) {
        ...
        imgTag.setAttribute('height', '350px');
        return imgTag;
    }
...
class VideoBlot extends BlockEmbed {
    ...
    static create(value) {
        if (value && value.src) {
            ...
            videoTag.setAttribute('height', '200px');
            ...
            iframeTag.setAttribute('height', '300px');
            return iframeTag;
        }
    }
...
class QuillEditor extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            editorHtml:  this.props.myHTML? this.props.myHTML : __ISMSIE__ ? "<p>&nbsp;</p>" : "",
